...
export const CATEGORIES = {
  ...
  sliding_door: {
    label: 'Sliding door',
    emoji: '\u{1FA9F}',
    query: '"sliding glass door" OR "patio door" OR "sliding door roller" OR "sliding door track" OR "slider door"',
    persona: 'sliding glass door repair technician',
  },
  gate: {
    label: 'Gate',
    emoji: '\u{1F6A7}',
  ...
  carpet_cleaning: {
    label: 'Carpet & tile',
    emoji: '\u{1F9FD}',
    query: '"carpet cleaning" OR "carpet cleaner" OR "clean my carpet" OR "carpet stain" OR "steam clean carpet" OR "upholstery cleaning" OR "pet urine carpet" OR "grout cleaning" OR "tile and grout" OR "regrout" OR "grout sealing"',
    persona: 'carpet, tile and grout cleaning technician',
  },
  chimney: {
    label: 'Chimney',
    emoji: '\u{1F3E0}',
...
export const ALL_TERMS_QUERY =
  '"garage door" OR "sliding glass door" OR "patio door" OR locksmith OR "locked out" OR rekey OR deadbolt OR "dryer vent" OR "duct cleaning" OR "air duct" OR "carpet cleaning" OR "carpet cleaner" OR chimney OR "gate opener" OR "driveway gate" OR "automatic gate"';
...
export const REGION_SUBS = {
  FL: [
    ...
    'tallahassee', 'GNV', 'sarasota', 'Pensacola', 'WestPalmBeach', 'naples',
