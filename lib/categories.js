...
export const CATEGORIES = {
  ...
  carpet_cleaning: {
    ...
    emoji: '\u{1F9FD}',
    query: '"carpet cleaning" OR "carpet cleaner" OR "clean my carpet" OR "carpet stain" OR "steam clean carpet" OR "upholstery cleaning" OR "pet urine carpet"',
    persona: 'carpet and upholstery cleaning technician',
  },
  chimney: {
    label: 'Chimney',
    emoji: '\u{1F3E0}',
